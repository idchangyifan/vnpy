...
########################################################################
class TradeCopyManager(QtWidgets.QWidget):
    """"""
    REQ_ADDRESS = 'tcp://127.0.0.1:2020'
    SUB_ADDRESS = 'tcp://127.0.0.1:2021'
    REP_ADDRESS = 'tcp://*:2020'
    PUB_ADDRESS = 'tcp://*:2021'
    COPY_RATIO = '1'
    INTERVAL = '1'
    ...
    def __init__(self, main_engine: MainEngine, event_engine: EventEngine):
        ...
        self.trade_copy_engine = main_engine.get_engine(APP_NAME)
    ...
    def registerEvent(self):
        ...
        self.event_engine.register(EVENT_LOG, self.signal.emit)
    ...
    def startProvider(self):
        ...
        self.trade_copy_engine.start_provider(repAddress, pubAddress, interval)
    ...
    def startSubscriber(self):
        ...
        self.trade_copy_engine.start_subscriber(reqAddress, subAddress, copyRatio)
